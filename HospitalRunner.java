class HospitalRunner {
	...
	isStarted = Hospital.startHospital("Apollo Hospital", "Bengaluru", "Dr. Ramesh", "Asha", 25, "Fever", 9856423654l, 101);
	...
	isStarted = Hospital.startHospital("Bowring Hospital", "Bengaluru", "Dr Ravi", "Pooja", 22, "Typhoid", 9856444124l, 107);
	System.out.println("Hospital started" + isStarted);
	Hospital.getHospital();
	System.out.println(" ");
	...
	isStarted = Hospital.startHospital("KIMS Hospital", "Hyderabad", "Dr Rekha", "Vijay", 39, "Viral Fever", 7844454690l, 110);
	...
	isStarted = Hospital.startHospital("Care Hospitals", "Hyderabad", "Dr Shilpa", "Divya", 26, "Cough", 9877742651l,112);
	System.out.println("Health started" + isStarted);
	Hospital.getHospital();
	System.out.println(" ");
	...
	isStarted = Hospital.startHospital("MIOT International", "Chennai", "Dr. Harish", "Sanjay", 48, "Heart Disease", 9876543225L, 116);
    System.out.println("Hospital Started: " + isStarted);
	Hospital.getHospital();
	System.out.println(" ");
	...
	System.out.println(" ");
		...
		isStarted = Hospital.startHospital("AIIMS Delhi", "New Delhi", "Dr. Vivek", "Amit", 30, "Fever", 9876543230L, 121);
		System.out.println("Hospital Started: " + isStarted);
		Hospital.getHospital();
		System.out.println(" ");
        ...
        isStarted = Hospital.startHospital("BLK-Max Hospital", "New Delhi", "Dr. Sharma", "Kavya", 24, "Asthma", 9876543233L, 124);
        System.out.println("Hospital Started: " + isStarted);
		Hospital.getHospital();
		System.out.println(" ");
        ...
        isStarted = Hospital.startHospital("Ruby Hall Clinic", "Pune", "Dr. Patil", "Om", 35, "Malaria", 9876543239L, 130);
        System.out.println("Hospital Started: " + isStarted);
		Hospital.getHospital();
		System.out.println(" ");
        ...
        isStarted = Hospital.startHospital("Kokilaben Dhirubhai Ambani Hospital", "Mumbai", "Dr. Shah", "Mohan", 44, "Cancer", 9876543243L, 134);
        System.out.println("Hospital Started: " + isStarted);
		Hospital.getHospital();
		System.out.println(" ");
        ...
        isStarted = Hospital.startHospital("King George's Medical University", "Lucknow", "Dr. Srivastava", "Ankit", 24, "Asthma", 9876543253L, 144);
        System.out.println("Hospital Started: " + isStarted);
		Hospital.getHospital();
		System.out.println(" ");

        isStarted = Hospital.startHospital("Postgraduate Institute of Medical Education and Research", "Chandigarh", "Dr. Gill", "Rohini", 29, "Allergy", 9876543254L, 145);
        System.out.println("Hospital Started: " + isStarted);
		Hospital.getHospital();
		System.out.println(" ");
        ...
        isStarted = Hospital.startHospital("Government Medical College Hospital", "Kozhikode", "Dr. Nair", "Athira", 28, "Viral Fever", 9876543257L, 148);
        System.out.println("Hospital Started: " + isStarted);
		Hospital.getHospital();
		System.out.println(" ");
        ...
        isStarted = Hospital.startHospital("Sri Ramachandra Medical Centre", "Chennai", "Dr. Balaji", "Varsha", 26, "Food Poisoning", 9876543259L, 150);
        System.out.println("Hospital Started: " + isStarted);
		Hospital.getHospital();
		System.out.println(" ");
